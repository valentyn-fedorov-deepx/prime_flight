...
| `module_consumption.md` + `.json` | код 27 модулів `external/<repo>` (default-гілки, свіжі клони) + `db_worker/ML_worker.py` | module-porter | **готово → review** (нотатка `tasks/notes/PF-Q1-14.md`; рішення → `decisions/ADR-001`) |
